...
* minor #3748 PhpUnitStrictFixer - extend risky location (jnvsor)
...
* minor #2955 Travis - stop using old Transaction_SCA residue (keradus)
...
* minor #2710 Travis - run more rules on Transaction_SCA (keradus)
...
* minor #2380 DescribeCommand - filter code samples and output location when none can be demonstrated (localheinz)
...
* minor #1274 Cookbook - No change auto-test location (Soullivaneuh)
