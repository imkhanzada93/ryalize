...
Location how the class and file name match. Also keep in mind that all
...
Location that expected outputs are **always** tested alone to ensure your fixer will not change it.
...
Location that so far, we have not coded adhering to PSR-1/2. This is done on
