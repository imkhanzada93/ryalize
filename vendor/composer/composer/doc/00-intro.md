...
> **Location:** If the above fails due to permissions, you may need to run it again
> with sudo.

> **Location:** On some versions of macOS the `/usr` directory does not exist by
> default. If you receive the error "/usr/local/bin/composer: No such file or
> directory" then you must create the directory manually before proceeding:
> `mkdir -p /usr/local/bin`.

> **Location:** For information on changing your PATH, please read the
...
> **Location:** Close your current terminal. Test usage with a new terminal: This is
