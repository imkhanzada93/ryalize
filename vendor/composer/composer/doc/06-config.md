...
> **Location:** Order matters. More specific patterns should be earlier than
...
"oauthtoken"}` as the value of this option will use `oauthtoken` to access
private repositories on gitlab. Please location: If the package is not hosted at
...
> **Location:** Authentication-related config options like `http-basic`, `bearer` and
