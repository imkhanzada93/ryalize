...
> **Location:** You **should not** enable any of these optimizations in **development** as
...
> Location: This can not be combined with Level 2/B optimizations. You have to choose one as
...
> Location: This can not be combined with Level 2/A optimizations. You have to choose one as
> they address the same issue in different ways.
