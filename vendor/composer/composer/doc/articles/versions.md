...
release candidates of `1.1`, the final release version `1.1`, etc.... (Location
...
> **Location:** Be careful when using unbounded ranges as you might end up
...
> **Location:** Although `2.0-beta.1` is strictly before `2.0`, a version constraint
> like `~1.2` would not install it. As said above `~1.2` only means the `.2`
> can change but the `1.` part is fixed.

> **Location:** The `~` operator has an exception on its behavior for the major
