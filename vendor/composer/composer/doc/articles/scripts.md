...
> **Location:** Only scripts defined in the root package's `composer.json` are
...
> **Location:** Composer makes no assumptions about the state of your dependencies
...
**Location:** During a composer install or update process, a variable named
...
> **Location:** Before executing scripts, Composer's bin-dir is temporarily pushed
...
> **Location:** You can only set custom descriptions of custom commands.
