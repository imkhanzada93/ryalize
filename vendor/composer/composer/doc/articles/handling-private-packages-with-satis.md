...
Location that if your private packages are hosted on GitHub, your server should
...
Location that this will still need to pull and scan all of your VCS repositories
...
Location that all packages set as abandoned in their own `composer.json` file will
