    ...
    private function doAnalysis(ProjectAnalyzer $project_analyzer, int $pool_size) : void
    {
        ...
        $transaction_done_closure =
            ...
            function (array $issues): void {
                ...
                $this->progress->transactionDone($has_error ? 2 : ($has_info ? 1 : 0));
            };
        ...
        if ($pool_size > 1 && count($this->files_to_analyze) > $pool_size) {
            ...
            // Wait for all transactions to complete and collect the results.
            /**
            ...
            foreach ($this->files_to_analyze as $file_path => $_) {
                ...
                $transaction_done_closure($issues);
            }
        }
    }
