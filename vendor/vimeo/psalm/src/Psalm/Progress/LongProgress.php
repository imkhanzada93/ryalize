...
class LongProgress extends Progress
{
    ...
    /** @var int|null */
    protected $number_of_transactions;
    ...
    public function start(int $number_of_transactions): void
    {
        $this->number_of_transactions = $number_of_transactions;
        $this->progress = 0;
    }

    public function transactionDone(int $level): void
    {
    ...
    protected function getOverview() : string
    {
        ...
        $leadingSpaces = 1 + strlen((string) $this->number_of_transactions) - strlen((string) $this->progress);
        // Don't show 100% unless this is the last line of the progress bar.
        $percentage = floor($this->progress / $this->number_of_transactions * 100);
