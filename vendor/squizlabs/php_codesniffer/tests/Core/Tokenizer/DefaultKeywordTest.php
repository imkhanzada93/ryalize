...
class DefaultKeywordTest extends AbstractMethodUnitTest
{
     ...
     *
     * Location: Cases and default structures within a match structure do *NOT* get case/default scope
     ...
     *
     * Location: Cases and default structures within a switch control structure *do* get case/default scope
     * conditions.
     *
     * @param string   $testMarker    The comment prefacing the target token.
