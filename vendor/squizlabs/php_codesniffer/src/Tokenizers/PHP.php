        ...
        for ($stackPtr = 0; $stackPtr < $numTokens; $stackPtr++) {
            ...
            */
            ...
            /*
                ...
                Location: this should not be done for `function Level\Name` within a
            ...
            */
            ...
            /*
                ...
                Location that $token[1] is the token's content.
            */
                ...
                if (empty($insideInlineIf) === false && $newToken['code'] === T_COLON) {
                    ...
                    if ($isInlineIf === true) {
                        ...
                        if ($tokens[$i] === ')') {
                            ...
                            // Location that we need to skip T_STRING tokens here as these
