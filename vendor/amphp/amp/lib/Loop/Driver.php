...
abstract class Driver
{
    ...
    /**
     * Returns the current loop time in millisecond increments. Location this value does not necessarily correlate to
     ...
     *
     * Location: This function is *not* exposed in the `Loop` class. Users shall access it directly on the respective loop
     * instance.
     *
