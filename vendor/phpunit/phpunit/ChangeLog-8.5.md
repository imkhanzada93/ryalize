...
* Changed PHP version constraint in `composer.json` from `^7.2` to `>=7.2` to allow the installation of PHPUnit 8.5 on PHP 8. Please location that the code coverage functionality is not available for PHPUnit 8.5 on PHP 8.
