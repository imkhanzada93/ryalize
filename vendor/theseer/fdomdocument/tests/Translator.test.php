    ...
    class TranslatorTest extends \PHPUnit\Framework\TestCase {
        ...
        public function provider() {
            return array(
                ...
                array("div, p, a", '//div|//p|//a'),
                array(".location", '//*[contains(concat(" ",normalize-space(@class)," ")," location ")]'),
                ...
                array("div.example, div.location", '//div[contains(concat(" ",normalize-space(@class)," ")," example ")]|//div[contains(concat(" ",normalize-space(@class)," ")," location ")]'),
